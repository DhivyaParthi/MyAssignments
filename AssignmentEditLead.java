...
public class AssignmentEditLead {
	...
	public static void main(String[] args) {
		...
		driverc.findElement(By.id("createLeadForm_firstName")).sendKeys("Dhivya12");
		...
		//To Edit the record
		driverc.findElement(By.linkText("Edit")).click();
		driverc.findElement(By.id("updateLeadForm_companyName")).sendKeys("TestLeaF11");
		driverc.findElement(By.className("smallSubmit")).click();
